...
type NavItem = {
  ...
  unitTypes?: string[]    // undefined = semua unitType
}
...
function filterNavItems(role: Role, unitType: string | null): NavItem[] {
  return NAV_ITEMS.filter((item) => {
    ...
    // Staff/Manager/Cashier: item tanpa unitTypes filter = semua boleh (Overview di-handle OWNER only)
  ...
  return (
    <aside className="w-64 bg-gray-900 text-white flex flex-col flex-shrink-0">
      ...
      <div className="px-6 py-5 border-b border-gray-700">
        <p className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-1">Bisnis Terpadu</p>
        <p className="text-white font-bold text-lg leading-tight">Dashboard</p>
      </div>
